# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-22 23:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('of_transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receipts', to='journalize.JournalEntry')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
