# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-06 01:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_journal', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='journalize.Journal')),
            ],
        ),
        migrations.AddField(
            model_name='receipt',
